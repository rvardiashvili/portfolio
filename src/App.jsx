...
const PHOTOS = [
  { id: 1, src: "/media/unnamed.jpg", desc: "Night Market", color: "bg-red-900" },
  { id: 2, src: "/media/unnamed (1).jpg", desc: "Silhouette", color: "bg-orange-900" },
  { id: 3, src: "/media/unnamed (2).jpg", desc: "Fog", color: "bg-slate-800" },
  { id: 4, src: "/media/unnamed (3).jpg", desc: "Archives", color: "bg-yellow-900" },
  { id: 5, src: "/media/DSC01653.JPG", desc: "Perspective", color: "bg-blue-900" },
  { id: 6, src: "/media/IMG_1097.JPG", desc: "Moment", color: "bg-green-900" }
];
             ...
             <div className="flex flex-col h-full justify-between">
               ...
               <div>
                 ...
                 <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <div className="px-3 py-1 rounded-full bg-white/5 border border-white/10 inline-flex items-center gap-2">
                       <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></div>
                       <span className="text-[10px] font-mono text-slate-200 uppercase tracking-widest">Available for Hire</span>
                    </div>
                 </div>
            ...
            <div className="lg:hidden flex flex-col items-center text-center mb-8 mt-8">
                <div className="relative mb-6">
                    <div className="w-28 h-28 rounded-full bg-gradient-to-br from-slate-800 to-black border-2 border-white/10 flex items-center justify-center shadow-xl overflow-hidden">
                        <img src="/media/pfp.png" alt="Rati Vardiashvili" className="w-full h-full object-cover" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-emerald-500/50 animate-pulse"></div>
                </div>
